# Business Problem: Rising Complaint Volumes and Regulatory Pressure

## 1. Market Context

UK financial firms face high and persistent levels of customer complaints.
...
In specific sectors, such as motor finance, regulators expect large scale redress and proactive handling.

- The FCA has proposed a motor finance redress scheme that may cover up to **14.2 million** agreements, with average payouts around **£700**.  
- FOS data shows record complaints about hire purchase motor products, which increases pressure on firms’ complaint processes.

Firms that fail to handle complaints at volume, meet regulatory timeframes, and maintain clear audit trails face the following risks.

- Breach of DISP rules and Consumer Duty  
- Enforcement action  
